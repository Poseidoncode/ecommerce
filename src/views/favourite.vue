  ...
  <div>
    ...
    >
      ...
      <div>
        ...
        <div class="flex items-center mt-2 justify-end mr-2">
          <span class="mr-3 cursor-pointer" @click.prevent="addToCart(itemData)"
            ><svg
              width="24"
              height="24"
              viewBox="0 0 24 24"
            ...
            >
              ...
              /></svg
          ></span>
          <span @click.prevent="deleteFavorite(itemData)"
            ><svg
              width="24"
              height="24"
              viewBox="0 0 24 24"
