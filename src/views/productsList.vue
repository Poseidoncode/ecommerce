<template>
  <div>
    <section>
      <div
        class="text-white bg-setting bg-setting-local"
        style="
      ...
      >
        ...
        <!-- <div class="css-backdropFilter">CSS backdrop-filter</div> -->
      </div>
    </section>
    <div
...
.bg-setting-local {
  // backdrop-filter: blur(1px) brightness(0.74) contrast(135%) grayscale(33%) !important;
  padding: 50px 200px;
}
</style>
