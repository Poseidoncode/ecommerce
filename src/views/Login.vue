<template>
  <section class="min-h-screen flex items-stretch text-white">
    <div class="lg:flex w-1/2 hidden bg-gray-500 bg-no-repeat bg-cover relative items-center" style="
      ...
      <div class="w-full px-24 z-10">
        <h1 class="text-5xl font-bold text-center tracking-wide mr-8 mb-1">
    ...
    <div class="lg:w-1/2 w-full flex items-center justify-center text-center md:px-16 px-0 z-0"
      ...
      <div class="w-full py-6 z-20">
        ...
        <form action="" class="sm:w-2/3 w-full px-4 lg:px-0 mx-auto">
          <div class="pb-2 pt-4">
            <input v-model="account" type="text" name="account" id="account" placeholder="Account"
              class="block w-full p-4 text-lg rounded-sm bg-black" />
          </div>
          <div class="pb-2 pt-4">
            <input v-model="password" class="block w-full p-4 text-lg rounded-sm bg-black" type="password"
