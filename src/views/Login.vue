<template>
  <section class="min-h-screen flex items-stretch text-white">
    ...
    >
      ...
      >
        <span class="cursor-pointer" @click.prevent="shareLink('twitter')">
          <svg
            fill="#fff"
        ...
        <span class="cursor-pointer" @click.prevent="shareLink('facebook')">
          <svg
            fill="#fff"
            xmlns="http://www.w3.org/2000/svg"
            width="24"
        ...
        <span class="cursor-pointer" @click.prevent="shareLink('instagram')">
          <svg
            fill="#fff"
            xmlns="http://www.w3.org/2000/svg"
            width="24"
